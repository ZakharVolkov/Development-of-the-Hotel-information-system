...
CREATE TABLE `bronirovanie` (
  ...
  CONSTRAINT `bronirovanie_ibfk_1` FOREIGN KEY (`Guest_code`) REFERENCES `guests` (`Guest_code`),
  CONSTRAINT `bronirovanie_ibfk_2` FOREIGN KEY (`Payment_method`) REFERENCES `payment_method` (`pay_method`)
...
INSERT INTO `bronirovanie` VALUES (1,'Карта',1,1,3);
